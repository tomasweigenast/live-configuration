...
const ApiResponse$json = const {
  '1': 'ApiResponse',
  '2': const [
    const {'1': 'status_code', '3': 1, '4': 1, '5': 14, '6': '.liveconfiguration.protobuf.ApiResponseStatusCode', '10': 'statusCode'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'error', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Any', '10': 'error'},
    const {'1': 'resource', '3': 4, '4': 1, '5': 11, '6': '.liveconfiguration.protobuf.ResourceInfo', '10': 'resource'},
  ],
};

/// Descriptor for `ApiResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List apiResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use errorDetailsDescriptor instead')
const ErrorDetails$json = const {
  '1': 'ErrorDetails',
  '2': const [
    const {'1': 'reason', '3': 1, '4': 1, '5': 9, '10': 'reason'},
    const {'1': 'metadata', '3': 3, '4': 3, '5': 11, '6': '.liveconfiguration.protobuf.ErrorDetails.MetadataEntry', '10': 'metadata'},
  ],
...
final $typed_data.Uint8List errorDetailsDescriptor = $convert.base64Decode('CgxFcnJvckRldGFpbHMSFgoGcmVhc29uGAEgASgJUgZyZWFzb24SUgoIbWV0YWRhdGEYAyADKAsyNi5saXZlY29uZmlndXJhdGlvbi5wcm90b2J1Zi5FcnJvckRldGFpbHMuTWV0YWRhdGFFbnRyeVIIbWV0YWRhdGEaOwoNTWV0YWRhdGFFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFsdWU6AjgB');
@$core.Deprecated('Use badRequestDescriptor instead')
const BadRequest$json = const {
  '1': 'BadRequest',
  '2': const [
    const {'1': 'field_violations', '3': 1, '4': 3, '5': 11, '6': '.liveconfiguration.protobuf.BadRequest.FieldViolation', '10': 'fieldViolations'},
  ],
...
final $typed_data.Uint8List badRequestDescriptor = $convert.base64Decode('CgpCYWRSZXF1ZXN0EmAKEGZpZWxkX3Zpb2xhdGlvbnMYASADKAsyNS5saXZlY29uZmlndXJhdGlvbi5wcm90b2J1Zi5CYWRSZXF1ZXN0LkZpZWxkVmlvbGF0aW9uUg9maWVsZFZpb2xhdGlvbnMaRAoORmllbGRWaW9sYXRpb24SFAoFZmllbGQYASABKAlSBWZpZWxkEhwKCXZpb2xhdGlvbhgCIAEoCVIJdmlvbGF0aW9u');
