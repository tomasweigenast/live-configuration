...
const ConfigurationEntryValueType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ConfigurationEntryValueType_BYTES', '2': 8},
  ],
};

/// Descriptor for `ConfigurationEntryValueType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List configurationEntryValueTypeDescriptor = $convert.base64Decode('');
...
const ConfigurationEntryValue$json = const {
  ...
  '2': const [
    ...
    const {'1': 'bytes_value', '3': 10, '4': 1, '5': 12, '9': 0, '10': 'bytesValue'},
  ],
...
final $typed_data.Uint8List configurationEntryValueDescriptor = $convert.base64Decode('');
