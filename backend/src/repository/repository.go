...
type Repository interface {
	...
	Update(ctx context.Context, entityId string, updateFunc UpdateFunc) (err error)

	// Finds one entity
	FindOne(ctx context.Context, id string) (model interface{}, err error)

	// Finds all the entities that matches a query
	FindAll(ctx context.Context, query Query) (models []interface{}, err error)

	// Deletes an entity
	Delete(ctx context.Context, entityId string) (err error)
}
